...
- 底部：用一句结论“它需要判断先做什么、缺什么信息、什么时候完成。”收束，不重复标题。
...
DRAWINGS
1. 大家常说某个产品加入了 Agent，意思通常不是多了一个聊天头像，而是 AI 开始围绕目标连续行动。
2. 普通聊天是一问一答，Agent 接到的更像任务：整理文件、比较方案、预约行程或检查网页。
3. 它需要判断先做什么、缺什么信息、什么时候完成。
