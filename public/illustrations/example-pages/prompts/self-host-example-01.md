...
DRAWINGS
1. 自己部署开源模型，经常被一句话说得太简单：下载模型，放到服务器上，运行就行。
2. 真做起来，它更像开一间自己的厨房。
3. 模型文件只是买回来的炉灶，想让顾客稳定吃上饭，还需要电力、空间、厨师、接单系统、卫生检查和维修计划。
4. 任何一项没有准备好，演示时能回答的问题，到了真实用户手里就可能卡住。
