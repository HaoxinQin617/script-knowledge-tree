---
id: rerank-explained-example-01
node_id: rerank-explained
language: zh-CN
aspect_ratio: "16:10"
backend: imagegen
reference_images: []
...
DRAWINGS
1. 例如问题询问某篇论文为什么选择 Transformer。
2. 初次检索可能同时找出发展历史、实验结果和其他模型介绍。
3. 它们都有相同词汇，却不一定直接回答原因。
